...
export const products = [
  {
    ...
    body: "Own and evolve high-value payment and cards capabilities that drive secure, real-time customer transactions.",
    icon: CreditCard,
  },
  {
    title: "Digital Onboarding",
    body: "Create fast, compliant digital journeys that reduce friction and increase customer conversion.",
    icon: Sparkles,
  },
  {
    title: "VeriBranch",
